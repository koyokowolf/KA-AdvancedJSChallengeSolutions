...
/*Step 1: Use the translate, pushMatrix, and popMatrix commands to move the rock #1 to the right, to block the path of the bug in the upper left.*/
...
/*Step 2: Use the translate, pushMatrix, and popMatrix commands to move rock #2 to the left, to block the path of the bug in the upper right.*/
...
/* Step 3: Use the translate, pushMatrix, and popMatrix commands to move rock #3 up, to block the path of the bug in the lower left.*/
...
/* Step 4: Use the translate, pushMatrix, and popMatrix commands to move rock #4 down and to the right, to simultaneously block both of the paths for the bug in the lower right corner.*/
