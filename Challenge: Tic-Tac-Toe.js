/*Step 1: Create and assign values to the following variables:
...
/* Step 3: Complete Tile's onClick method which will implement a major part of the logic for the game. For empty tiles the onClick method should perform the following:
